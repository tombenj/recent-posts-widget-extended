...
if ( ! class_exists( 'Image_Resizer' ) ) {
	...
	class Image_Resizer {
		...
		public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
			...
			if ( true === $upscale ) {
				add_filter( 'image_resize_dimensions', array( $this, 'rposts_upscale' ), 10, 6 );
			}
			...
			// Okay, leave the ship.
			if ( true === $upscale ) {
				remove_filter( 'image_resize_dimensions', array( $this, 'rposts_upscale' ) );
			}
		 ...
		 * @return array
		 */
		public function rposts_upscale( $default, $orig_w, $orig_h, $dest_w, $dest_h, $crop ) {
			if ( ! $crop ) {
...
if ( ! function_exists( 'rposts_image_resize' ) ) {
	/**
	 * Wrapper function
	 *
	 * @param string  $url The image url.
	 ...
	 * @return (string|array)[]
	 */
	function rposts_image_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
